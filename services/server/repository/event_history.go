...
type EventHistoryRepository interface {
	...
	List(ctx context.Context, filter EventFilter) ([]model.EventHistory, error)
}
...
func (r *gormEventHistoryRepository) Create(ctx context.Context, event model.EventHistory) (model.EventHistory, error) {
...
func (r *gormEventHistoryRepository) List(ctx context.Context, filter EventFilter) ([]model.EventHistory, error) {
	qe := r.q.EventHistory
	...
	events := make([]model.EventHistory, len(rows))
