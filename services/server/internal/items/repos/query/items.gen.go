...
func newItem(db *gorm.DB, opts ...gen.DOOption) item {
	...
	_item.itemDo.UseModel(&models.Item{})

	tableName := _item.itemDo.TableName()
	_item.ALL = field.NewAsterisk(tableName)
	_item.ID = field.NewField(tableName, "id")
...
type IItemDo interface {
	...
	Unscoped() IItemDo
	Create(values ...*models.Item) error
	CreateInBatches(values []*models.Item, batchSize int) error
	Save(values ...*models.Item) error
	First() (*models.Item, error)
	Take() (*models.Item, error)
	Last() (*models.Item, error)
	Find() ([]*models.Item, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Item, err error)
	FindInBatches(result *[]*models.Item, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.Item) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.Item, error)
	FirstOrCreate() (*models.Item, error)
	FindByPage(offset int, limit int) (result []*models.Item, count int64, err error)
...
func (i itemDo) Create(values ...*models.Item) error {
	if len(values) == 0 {
		return nil
	}
...
func (i itemDo) CreateInBatches(values []*models.Item, batchSize int) error {
	return i.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (i itemDo) Save(values ...*models.Item) error {
	if len(values) == 0 {
		return nil
	}
...
func (i itemDo) First() (*models.Item, error) {
	if result, err := i.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.Item), nil
	}
}

func (i itemDo) Take() (*models.Item, error) {
...
func (i itemDo) Last() (*models.Item, error) {
...
func (i itemDo) Find() ([]*models.Item, error) {
	result, err := i.DO.Find()
	return result.([]*models.Item), err
}

func (i itemDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Item, err error) {
	buf := make([]*models.Item, 0, batchSize)
...
func (i itemDo) FindInBatches(result *[]*models.Item, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (i itemDo) FirstOrInit() (*models.Item, error) {
...
func (i itemDo) FirstOrCreate() (*models.Item, error) {
...
func (i itemDo) FindByPage(offset int, limit int) (result []*models.Item, count int64, err error) {
...
func (i itemDo) Delete(models ...*models.Item) (result gen.ResultInfo, err error) {
